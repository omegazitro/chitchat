<template>
  <div class="container mx-auto flex my-4 rounded-full" :class="isUser ? 'bg-green-800' : 'bg-gray-700'">
    <div>
      <img
    ...
    <div class="flex flex-grow">
      <div
        class="flex flex-grow items-center justify-between mx-4 font-thin text-xl text-blue-200"
      >
        <p>{{ message.text }}</p>
