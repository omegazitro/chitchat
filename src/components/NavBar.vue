    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="menu">
        <div v-if="!isAuthenticated">
          <button
            class="bg-green-700 text-white py-2 px-4 rounded-full hover:bg-green-900 focus:outline-non focus:ring-4 focus:ring-green-500"
            @click="googlePopup"
          >
            Login
          </button>
        ...
        <div v-else class="flex items-center space-x-8">
          ...
          <button
            class="bg-red-700 text-white py-2 px-4 rounded-full hover:bg-red-900 focus:outline-non focus:ring-4 focus:ring-green-500"
            @click="signOut"
          >
            Logout
          </button>
